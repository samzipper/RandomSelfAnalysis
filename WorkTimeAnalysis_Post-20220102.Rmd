...
Across all of 2021, my time breaks down as:
 ...
 - `travel` = `r round(work_by_year$Time_Prc[work_by_year$Year == 2021 & work_by_year$Activity == "travel"]*100, 1)`%
...
For 2022, my goals are: 
 ...
 - Reduce the number of `field` days. I love field work, but 34 days is too many since it strains our family's childcare schedule. I'm aiming for 24 total days (2/month) next year.
